...
#define FLAG_NEO_AQUA_LILYCOVE_MET    0x20 // Unused Flag
#define FLAG_ROUTE121_SHOW_RIVAL    0x21 // Unused Flag
#define FLAG_FABLED_ISLAND_FINISH    0x22 // Unused Flag
#define FLAG_FABLED_ISLAND_START    0x23 // Unused Flag
#define FLAG_FABLED_ISLAND_HORDE_BEATEN    0x24 // Unused Flag
#define FLAG_HIDE_FABLED_ISLAND_HORDE    0x25 // Use to hide the team aqua / magma members & rival
#define FLAG_NEO_EVENT_DONE    0x26 // Use to cleanup events after Maxie & Archie Defeated
#define FLAG_FINAL_RIVAL_BATTLE    0x27 // Used after rival defeated at FI Summit
...
#define FLAG_HIDDEN_ITEM_ROUTE_135_NUGGET                    (FLAG_HIDDEN_ITEMS_START + 0x71)
#define FLAG_HIDDEN_ITEM_ROUTE_135_STARF                     (FLAG_HIDDEN_ITEMS_START + 0x72)
#define FLAG_HIDDEN_ITEM_ROUTE_135_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x73)
#define FLAG_HIDDEN_ITEM_ROUTE_135_MAX_REVIVE                (FLAG_HIDDEN_ITEMS_START + 0x74)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_INTERIOR_MAX_REVIVE   (FLAG_HIDDEN_ITEMS_START + 0X75)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_STARF1                (FLAG_HIDDEN_ITEMS_START + 0X76)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_STARF2                (FLAG_HIDDEN_ITEMS_START + 0X77)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_ENIGMA                (FLAG_HIDDEN_ITEMS_START + 0X78)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_ENIGMA2               (FLAG_HIDDEN_ITEMS_START + 0X79)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_MAX_REVIVE            (FLAG_HIDDEN_ITEMS_START + 0X7A)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_REVIVAL_HERB          (FLAG_HIDDEN_ITEMS_START + 0X7B)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_GANLON                (FLAG_HIDDEN_ITEMS_START + 0X7C)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_LIECHI                (FLAG_HIDDEN_ITEMS_START + 0X7D)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_SALAC                 (FLAG_HIDDEN_ITEMS_START + 0X7E)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_PETAYA                (FLAG_HIDDEN_ITEMS_START + 0X7F)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_APICOT                (FLAG_HIDDEN_ITEMS_START + 0X80)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_LANSAT                (FLAG_HIDDEN_ITEMS_START + 0X81)
#define FLAG_HIDDEN_ITEM_FABLED_ISLAND_INTERIOR_MAX_ETHER    (FLAG_HIDDEN_ITEMS_START + 0X82)
